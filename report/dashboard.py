...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        asset_id = model.event_counts(entity_id)
        ...
        # ['Positive', 'Negative']
        asset_id.columns = ['Positive', 'Negative']
        ...
        axs.set_title('Cumulative Event Count')
        axs.set_xlabel('Day')
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        preditions = self.predictor.predict_proba(data)
...
@app.route("/employee/<string:id>", method=["GET"])
def get_employee_report(id):
...
# to a string datatype
@app.route("/team/<string:id>", method=["GET"])
def get_team_report(id):
