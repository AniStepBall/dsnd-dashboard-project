...
def test_db_exists(db_path):
    ...
    assert db_path.is_file(), f"{db_path} doesn't contain the database"
...
def test_employee_table_exists(table_names):
    ...
    assert "employee" in table_names, f"The `employee` table isn't in the table_name list"
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert "team" in table_names, f"The `team` table isn't in the table_name list"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert "employee_events" in table_names, f"The `employee_events` table isn't in the table_name list"
